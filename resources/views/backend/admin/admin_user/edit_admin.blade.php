...
@section('admin_content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Update Admin User</div>
        <div class="ps-3">
        ...
        <div class="main-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.update.admin.role', $user->id) }}" method="post">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="numeric" name="phone" value="{{ $user->phone }}"
