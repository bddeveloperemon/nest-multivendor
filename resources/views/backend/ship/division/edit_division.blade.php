...
@section('admin_content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Update Division</div>
        <div class="ps-3">
        ...
        <div class="main-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.update.division', $division->id) }}" id="myForm" method="post">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text"
                                            ...
                                            name="division_name" id="division_name" value="{{ $division->division_name }}"
