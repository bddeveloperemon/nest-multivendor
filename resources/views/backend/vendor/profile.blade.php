                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            @if (!empty($vendorData->image))
                                <img src="{{ asset('upload/vendor_images/'.$vendorData->image) }}" alt="Vendor" class="rounded-circle p-1 bg-primary" width="110">
                                
                            @else
                            <img src="{{ asset('backend/assets/images/avatars/avatar-500.png') }}" alt="Vendor" class="rounded-circle p-1 bg-primary" width="110">
                        ...
                        <form action="{{ route('vendor.profile.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{ $vendorData->username }}" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $vendorData->name }}" placeholder="enter shop name">
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $vendorData->email }}" placeholder="enter vendor email address">
                                    @error('email')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ $vendorData->phone }}" placeholder="enter vendor mobile number">
                                    @error('phone')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ $vendorData->address }}" placeholder="enter vendor address">
                                    @error('address')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <select class="form-select mb-3" name="vendor_join" class="@error('vendor_join') is-invalid @enderror" aria-label="Default select example">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <textarea name="vendor_short_info" class="form-control @error('vendor_short_info') is-invalid @enderror" placeholder="vendor info">{{ $vendorData->vendor_short_info }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="show_image" src="{{ (!empty($vendorData->image)) ? url('upload/vendor_images/'.$vendorData->image):url('backend/assets/images/avatars/avatar-500.png')  }}" alt="Admin" style="width:120px; height:120px;">
                                </div>
                            </div>
                            <div class="row">
