...
<div class="col-md-3">
    <div class="dashboard-menu">
        <ul class="nav flex-column" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $route == 'track.your.order' ? 'active' : '' }}"
                    href="{{ route('track.your.order') }}"><i class="fi-rs-shopping-cart mr-10"></i>Track Your Order</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $route == 'user.account.page' ? 'active' : '' }}"
                    href="{{ route('user.account.page') }}"><i class="fi-rs-user mr-10"></i>Account
                    details</a>
            </li>
            <li class="nav-item">
