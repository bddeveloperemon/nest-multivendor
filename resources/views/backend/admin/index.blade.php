...
@section('admin_content')
    @php
        ...
        $vendor = App\Models\User::where(['status' => 'active', 'role' => 'vendor'])->get();
        $customer = App\Models\User::where(['status' => 'active', 'role' => 'user'])->get();
    @endphp
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
        ...
        <div class="col">
            <div class="card radius-10 bg-gradient-ibiza">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h5 class="mb-0 text-white">{{ count($pending_order) }}</h5>
                        <div class="ms-auto">
                            <i class='bx bx-dollar fs-3 text-white'></i>
                        </div>
                    </div>
                    ...
                    <tbody>
                        @foreach ($orders as $key => $order)
                            <tr>
                                ...
                                <td>
                                    <div class="badge rounded-pill bg-light-warning text-warning w-100">
                                        {{ $order->status }}
                                    </div>
                                </td>
                            </tr>
