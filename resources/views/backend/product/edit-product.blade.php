                        ...
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="product_name" class="form-control" id="inputProductTitle" placeholder="Enter product name" value="{{ $product->product_name }}">
                                </div>
                                <div class="form-group mb-3">
                            ...
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="selling_price" value="{{ $product->selling_price }}" id="inputPrice" placeholder="00.00">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputCompareatprice" class="form-label">Discount Price</label>
                                        <input type="number" name="discount_price" value="{{ $product->discount_price }}"  class="form-control" id="inputCompareatprice" placeholder="00.00">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputCostPerPrice" class="form-label">Product Code</label>
                                        <input type="text" name="product_code" value="{{ $product->product_code }}"  class="form-control" id="inputCostPerPrice" placeholder="Enter code">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputStarPoints" class="form-label">Product QTY</label>
                                        <input type="number" name="product_qty" value="{{ $product->product_qty }}"  class="form-control" id="inputStarPoints" placeholder="Enter qty">
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="subcategory_id" class="form-select" id="inputCollection">
                                            ...
                                            @foreach ($subcategories as $subcategory)
                                                <option value="{{ $subcategory->id }}" @if ($product->subcategory_id == $subcategory->id)
                                                    selected
                                                    @endif>{{ $subcategory->sub_category_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <select name="vendor_id" class="form-select" id="inputCollection">
                                            ...
                                            @foreach ($activeVendors as $vendor)
                                                <option value="{{ $vendor->id }}" @if ($vendor->id == $product->vendor_id)
                                                    selected
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1" name="hot_deals" id="flexCheckDefault" @if ( $product->hot_deals == 1)
                                                    checked
                                                    @endif>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" @if ( $product->featured == 1)
                                                    checked
                                                    @endif name="featured" id="flexCheckDefault" value="1">
                                                    <label class="form-check-label" for="flexCheckDefault">Featured</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1" name="special_offer" id="flexCheckDefault"  @if ( $product->special_offer == 1)
                                                    checked
                                                    @endif>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1" name="special_deals" id="flexCheckDefault" @if ( $product->special_deals == 1)
                                                    checked
                                                    @endif>
