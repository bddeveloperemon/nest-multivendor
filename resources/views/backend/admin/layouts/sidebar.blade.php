<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('brand.list'))
                        <li> <a href="{{ route('admin.all.brands') }}"><i class="bx bx-right-arrow-alt"></i>All
                                Brand</a>
                        </li>
                    @endif
            ...
            <li>
                ...
                <ul>
                    ...
                    @if (Auth::user()->can('category.add'))
                        <li> <a href="{{ route('admin.add.category') }}"><i class="bx bx-right-arrow-alt"></i>Add
                                Category</a>
                        </li>
                    @endif
                </ul>
            ...
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('product.list'))
                        <li> <a href="{{ route('admin.all.products') }}"><i class="bx bx-right-arrow-alt"></i>Product
                                List</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('product.add'))
                        <li> <a href="{{ route('admin.add.product') }}"><i class="bx bx-right-arrow-alt"></i>Add
                                Product</a>
                        </li>
                    @endif
                </ul>
            ...
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('slider.all'))
                        <li> <a href="{{ route('admin.all.slider') }}"><i class="bx bx-right-arrow-alt"></i>Slider
                                List</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('slider.add'))
                        <li> <a href="{{ route('admin.add.slider') }}"><i class="bx bx-right-arrow-alt"></i>Add
                                Slider</a>
                        </li>
                    @endif
                </ul>
            ...
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('banner.add'))
                        <li> <a href="{{ route('admin.all.banner') }}"><i class="bx bx-right-arrow-alt"></i>Banner
                                List</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('banner.list'))
                        <li> <a href="{{ route('admin.add.banner') }}"><i class="bx bx-right-arrow-alt"></i>Add
                                Banner</a>
                        </li>
                    @endif
                </ul>
            ...
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('coupon.list'))
                        <li> <a href="{{ route('admin.all.cupon') }}"><i class="bx bx-right-arrow-alt"></i>All
                                Cupon</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('coupon.add'))
                        <li> <a href="{{ route('admin.add.cupon') }}"><i class="bx bx-right-arrow-alt"></i>Add
                                Cupon</a>
                        </li>
                    @endif
                </ul>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('admin.all.division') }}"><i class="bx bx-right-arrow-alt"></i>All
                        Division</a>
                </li>
                <li> <a href="{{ route('admin.all.district') }}"><i class="bx bx-right-arrow-alt"></i>All
                        District</a>
                </li>
        ...
        @if (Auth::user()->can('order.menu'))
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin.processing.order') }}"><i
                                class="bx bx-right-arrow-alt"></i>Processing
                            Order</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.deliverded.order') }}"><i
                                class="bx bx-right-arrow-alt"></i>Deliverded
                            Order</a>
                    </li>
                </ul>
            </li>
        ...
        @if (Auth::user()->can('report.menu'))
            <li>
                ...
                <ul>
                    <li> <a href="{{ route('admin.report.view') }}"><i class="bx bx-right-arrow-alt"></i>Report
                            View</a>
                    </li>
        ...
        @if (Auth::user()->can('user.management.menu'))
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="{{ route('admin.all.vendor') }}"><i class="bx bx-right-arrow-alt"></i>All
                            Vendor</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('blog.list'))
                        <li> <a href="{{ route('admin.blog.category') }}"><i class="bx bx-right-arrow-alt"></i>All
                                Blog
                                Category</a>
                        </li>
                    @endif
            ...
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="{{ route('admin.add.roles.permission') }}"><i
                                class="bx bx-right-arrow-alt"></i>Roles
                            in
                            Permission</a>
                    </li>
        ...
        @if (Auth::user()->can('admin.user.menu'))
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="{{ route('admin.add.admin') }}"><i class="bx bx-right-arrow-alt"></i>Add Admin</a>
                    </li>
                </ul>
            </li>
        @endif
