                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.update.slider', $slider->id) }}" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="short_title"
                                            ...
                                            value="{{ $slider->short_title }}" placeholder="Enter Short Title">
                                        @error('short_title')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="show_image"
                                            src="{{ !empty($slider->slider_image) ? url('upload/slider_images/' . $slider->slider_image) : url('backend/assets/images/No_Image.png') }}"
                                            alt="Slider" style="width:120px; height:120px;">
                                    </div>
                                </div>
                                <div class="row">
