...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">Update Sub-Category</div>
    <div class="ps-3">
    ...
    <div class="ms-auto">
        <div class="btn-group">
            <a href="{{ route('admin.all.subcategories') }}" class="btn btn-danger btn-sm">Back</a>
        </div>
    </div>
</div>
<!--end breadcrumb-->
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.update.subcategory',$subcategory->id) }}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control @error('sub_category_name') is-invalid @enderror" name="sub_category_name" id="sub_category_name" placeholder="Enter Sub Category Name" value="{{ $subcategory->sub_category_name }}">
